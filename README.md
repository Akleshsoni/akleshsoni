💫 Hi 👋, I'm Aklesh Soni
About Me:
I am a Computer Science Engineering student (2027 batch) with hands-on experience in full-stack and backend development. I specialize in building scalable web applications using React, Node.js, FastAPI, and REST APIs, with a strong focus on clean architecture and real-world problem solving.
I have built production-grade systems including an AI-powered Transaction Pipeline (FastAPI + Celery + Redis + PostgreSQL + Gemini Flash), a Multi-Modal Evidence Review system (Claude AI + Vision), a free Resume Builder (deployed on Vercel), a full-stack Billing System, and an AI Disaster Prediction System. These experiences have strengthened my ability to design systems, integrate LLMs, and ship working products.
I am particularly interested in backend systems, API development, LLM integrations, and how scalable applications are built and maintained. I continuously improve my skills in system design, DevOps practices, and real-world engineering problem solving.
...
---
![](https://visitcount.itsvg.in/api?id=Akleshsoni&icon=0&color=0)
